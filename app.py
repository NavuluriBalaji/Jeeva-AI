...
def login():
    if request.method == 'POST':
        ...
        try:
            ...
            if verify_password(user.uid, password):
                return redirect('/')
            else:
...
def register():
    if request.method == 'POST':
        ...
        doctors_visited = request.form['doctorsVisited']
        gender = request.form['gender']
        age = request.form['age']
        # Save user data to the database (implementation depends on your database setup)
